  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 whitespace-nowrap rounded-lg border border-gray-700 px-2 py-1 text-[11px] text-gray-400 transition hover:border-gray-600 hover:text-white sm:gap-2 sm:px-3 sm:py-1.5 sm:text-sm"
      >
        ...
        <span className="whitespace-nowrap sm:hidden">
          {isLoading ? "Laden..." : `${onlineUsers.length} online`}
        </span>
