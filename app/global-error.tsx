...
// Use dynamic import with ssr: false to avoid prerendering issues in Next.js 16
// This prevents the "Expected workStore to be initialized" error during build.
const GlobalErrorContent = dynamic(() => Promise.resolve(({ error, reset }: { error: any, reset: () => void }) => (
